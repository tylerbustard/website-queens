...
export default function Navigation() {
  ...
  const handleDropdownLeave = () => {
    ...
    }, 300); // Increased delay to allow for clicks
  ...
  const scrollToSection = (href: string) => {
    ...
    if (isResumePage) {
      console.log('On resume page, scrolling to:', href);
      ...
      if (element) {
        ...
        allElementsWithIds.forEach(el => console.log('ID:', el.id));
      }
      setIsMobileMenuOpen(false);
      return;
    }
          ...
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <div className="hidden lg:flex items-center space-x-1">
              ...
              {isResumePage && (
                      ...
                      <div className="absolute top-full left-0 -mt-1 w-80 z-[55] pt-1">
                        ...
                        >
                          <div className="space-y-3">
                            {/* Queen's University (Resume: scroll to top of Education) */}
                            <button 
                              onClick={(e) => {
                                e.stopPropagation();
                                e.preventDefault();
                                scrollToSection('#education-queens-university');
                                setOpenDropdown(null);
                              }}
                ...
                <div className="text-xs text-gray-600">tyler@tylerbustard.net</div>
                              </div>
                            </button>
                    ...
                    <div className="absolute top-full left-0 -mt-1 w-80 z-[55] pt-1">
                      ...
                      >
                        <div className="space-y-3">
                          ...
                          <button 
                            onClick={() => {
                              scrollToSection('#queens-education');
                              setOpenDropdown(null);
                            }}
                            className="w-full text-left hover:bg-gray-100/50 rounded-lg p-3 transition-all duration-200 group"
                          >
              ...
              {isResumePage && (
                <div className="hidden lg:block">
                  <button 
                    ...
                    data-testid="button-download-pdf-nav"
                  >
                    <Printer size={16} />
                    Download PDF
                  </button>
              ...
              {(isResumePage || isUploadPage || isSignInPage) ? (
                <div className="flex items-center space-x-2 lg:hidden">
                  {isResumePage && (
                    <button
                      onClick={() => window.print()}
                      className="p-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-all duration-200 active:scale-95"
                      aria-label="Download resume as PDF"
                    >
                      <Printer size={20} />
                    </button>
                ...
                {isHomePage && (
                  <>
                    <button 
                      ...
                      className="block w-full text-left px-4 py-3 text-lg font-medium text-gray-900 hover:bg-gray-100/50 rounded-lg transition-all duration-200 active:scale-98 mobile-menu-item"
                    >
                      Education
                    </button>
                    <button 
                    ...
                    <button 
                      ...
                      className="block w-full text-left px-4 py-3 text-lg font-medium text-gray-900 hover:bg-gray-100/50 rounded-lg transition-colors mobile-menu-item"
                    >
                      Community
                    </button>
                    <button 
