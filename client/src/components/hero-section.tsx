              ...
              <div className="flex-1 space-y-6 sm:space-y-8 text-center lg:text-left">
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="space-y-2 sm:space-y-3">
                    <h1 className="text-4xl sm:text-5xl lg:text-7xl text-gray-900 dark:text-white tracking-tight leading-[0.95] sm:leading-[0.9] break-words" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", sans-serif' }}>
                      <span className="font-bold">Tyler</span>{' '}
                      <span className="font-normal">Bustard</span>
                    </h1>
                  </div>
                  <p className="text-lg sm:text-2xl lg:text-3xl font-semibold text-primary leading-snug sm:leading-tight" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Text", sans-serif' }}>
                    Finance & Technology Professional
                  </p>
                </div>

                {/* Description */}
                <p className="text-sm sm:text-lg lg:text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto lg:mx-0" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Text", sans-serif' }}>
                ...
                <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 pt-2 sm:pt-4">
                  ...
                  {Boolean(videosQuery.data && Array.isArray(videosQuery.data) && videosQuery.data.length > 0) && (
                    ...
                    >
                      ...
                      <span className="sm:hidden">Intro Video</span>
                      <span className="hidden sm:inline">{Boolean(videosQuery.data && Array.isArray(videosQuery.data) && videosQuery.data.length > 0 && videosQuery.data.find((video: any) => video.isActive)) ? 'Watch Introduction Video' : 'Introduction'}</span>
                    </Button>
                  )}
                </div>
              </div>
