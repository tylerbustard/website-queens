              ...
              <div className="flex-1 space-y-6 sm:space-y-8 text-center lg:text-left">
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="space-y-2 sm:space-y-3">
                    <h1 className="text-4xl sm:text-5xl lg:text-7xl text-gray-900 dark:text-white tracking-tight leading-[0.95] sm:leading-[0.9] break-words font-display">
                      <span className="font-bold">Tyler</span>{' '}
                      <span className="font-normal">Bustard</span>
                    </h1>
                  </div>
                  <p className="text-lg sm:text-2xl lg:text-3xl font-semibold text-primary leading-snug sm:leading-tight font-apple">
