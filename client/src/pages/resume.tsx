    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="resume-page bg-white rounded-2xl shadow-lg mb-6 print:shadow-none print:border-0 print:rounded-none">
            ...
            <div className="mb-6">
              ...
              <div id="contact" className="mt-4 grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs">
                <a
                  href="mailto:tyler@tylerbustard.net"
                ...
                >
                  <Mail className="w-3.5 h-3.5 text-blue-500" /> tyler@tylerbustard.net
                </a>
                <a
                ...
                <a
                  href="https://tylerbustard.net"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center sm:justify-start gap-1.5 px-3 py-1.5 rounded-full bg-gray-50 text-gray-700 border border-gray-200 hover:bg-gray-100 transition-colors"
                  aria-label="Visit Tyler Bustard website"
                >
                  <Globe className="w-3.5 h-3.5 text-blue-500" /> tylerbustard.net
                </a>
      ...
      <style>{`
        @media print {
          ...
          .text-blue-600 { color: #2563eb !important; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
          .text-blue-500 { color: #3b82f6 !important; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
